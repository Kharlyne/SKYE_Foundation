...
const ArticleDetail = () => {
    ...
    return (
      <div className="article-not-found">
        <div className="container">
          ...
          <button onClick={() => navigate('/article')} className="back-btn">Voir tous les articles</button>
        </div>
      </div>
    );
  }
  ...
  const renderContent = () => {
    ...
    try { parsed = JSON.parse(article.content); } catch {}
    ...
    <main className="article-detail">
      <div className="container">
        ...
        <div className="article-header">
          ...
          <h1>{article.title}</h1>
          <div className="meta"><span className="date">{article.date}</span></div>
        </div>
        ...
        <div className="article-footer">
          <button onClick={() => navigate('/article')} className="more-articles">Voir tous les articles</button>
        </div>
      </div>
    </main>
  );
